...
def convlayer(l, bn, dr, ps, n_kerns, d_kerns, nonlinearity, pad, stride, W=lasagne.init.GlorotUniform(),
              b=lasagne.init.Constant(0.), name=None):
    l = lasagne.layers.Conv2DLayer(l, num_filters=n_kerns, filter_size=d_kerns, stride=stride, pad=pad, W=W, b=b,
