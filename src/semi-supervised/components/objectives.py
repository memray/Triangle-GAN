...
def categorical_crossentropy_ssl_alternative(predictions, targets, num_labelled, weight_decay, alpha_labeled=1.,
...
def categorical_crossentropy_ssl(predictions, targets, num_labelled, weight_decay, alpha_labeled=1., alpha_unlabeled=.3,
...
def multiclass_s3vm_loss(predictions_l, targets, predictions_u, weight_decay, alpha_labeled=1., alpha_unlabeled=1.,
                         alpha_average=1., alpha_decay=1., delta=1., norm_type=2, form='mean_class',
                         entropy_term=False):
    '''
    predictions: 
        size L x nc
